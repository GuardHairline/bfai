...
class BaHoursBasis(db.Model):
    __tablename__ = 'ba_hours_basis'
    ...
    update_time = db.Column(db.DateTime)
    department = db.Column(db.String(32))
    first_task = db.Column(db.String(32))
    change_type = db.Column(db.String(32))
    power_type = db.Column(db.String(32))
    market = db.Column(db.String(500))
    total_hour = db.Column(db.String(32))
    re_project = db.Column(db.String(32))
    de_range = db.Column(db.String(2000))
    edit_status = db.Column(db.String(32))
    reason = db.Column(db.String(2500))
    parent_id = db.Column(db.BigInteger)
    ancestor_id = db.Column(db.BigInteger)
    in_status = db.Column(db.String(32))
    delete_tag = db.Column(db.Boolean)
    change_no = db.Column(db.String(32))
    change_status = db.Column(db.String(100))
    valid = db.Column(db.Integer)
    data_flow_id = db.Column(db.String(32))
    create_by_name = db.Column(db.String(32))
    serial_number = db.Column(db.String(32))
    section_office = db.Column(db.String(32))
    part_name = db.Column(db.String(500))
    service_regulations = db.Column(db.String(32))
    create_time_name = db.Column(db.DateTime)
    update_by_name = db.Column(db.String(32))
    update_time_name = db.Column(db.DateTime)

class LisTask(db.Model):
    __tablename__ = 'lis_task'
    ...
    update_by = db.Column(db.BigInteger)
    update_time = db.Column(db.DateTime)
    first_task = db.Column(db.String(500))
    department = db.Column(db.String(100))
    section_office = db.Column(db.String(100))
    task_code = db.Column(db.String(32))
    delete_tag = db.Column(db.Boolean)